...
const FirebaseIcon = () => (
  <div>
    <a className='item__icon' href='https://firebase.google.com/' target='_blank' title='Firebase'>
      <svg viewBox='0 0 48 48'>
        ...
        <polygon fill='#FF6F00' points='8.008,36.986 8.208,36.829 25.737,22.488 20.793,13.012 '></polygon>
